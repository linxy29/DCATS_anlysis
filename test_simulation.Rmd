...
This file is used to test whether the evaluation process has problems and the file used for final simulation results
...
simulation = list(numb_cond1 = as.matrix(numb_cond1), numb_cond2 = as.matrix(numb_cond2), knn_mat = simil_matK, knnGraphs = graphs, labels = labels)
save(simulation, file = "./data/real_world/simulation.RData")
```
...
concentration = 120 # indicate how simulated proportion far away from true, the larger the closer
setresolu = 0.8
rep1 = 4
rep2 = 4
simulation_times = 20
