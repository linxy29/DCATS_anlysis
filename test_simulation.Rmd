...
concentration = 140 # indicate how simulated proportion far away from true, the larger the closer
setresolu = 1.4
rep1 = 3
rep2 = 2
simulation_times = 20
...
```{r}
probC1 = c(rep(0.1, 5), 0.05, 0.05, 0.05, 0.1, 0.15, 0.05, 0.05)  # True proportions
probC2 = c(rep(0.1, 10), 0.05, 0.05)
truthRes = c(rep("N", 5), rep("P", 5), "N", "N")
```
...
for (sim in 1:simulation_times){
  print(sim)
  timeL = rep(NA, 8) # DCATS w/wto simularity matrix, fisher, speckle, diffcyt, scDC
  ## simulation
