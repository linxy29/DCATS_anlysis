...
batch_num = 4
cell.prop = c(1/3, 1/3, 1/3)
de.prop = c(0, 0.09, 0.2) ## percentage of DE genes, total is 1000 genes
options(future.globals.maxSize = 15000 * 1024^2)
```
...
for (clu in 2:cluster_num) {
  DE_multiplier = c(runif(n = 1000*de.prop[clu]/2, min = 0.1, max = 1), runif(n = 1000*de.prop[clu]/2, min = 1, max = 10))
