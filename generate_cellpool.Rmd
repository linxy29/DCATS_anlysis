...
de_prob[1:round(cluster_num/3)] = runif(round(cluster_num/3), 0.1, 0.3)
de_prob[(round(cluster_num/3)+1):cluster_num] = runif((cluster_num - round(cluster_num/3)), 0.4, 1)
setresolu = 0.5
```
...
save(sim_mat, origLabels, file = str_c("./data/cells_pool", as.character(cluster_num), "_splatter.RData"))
```
