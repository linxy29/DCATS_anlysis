...
#de.prop = c(0, 0.03, 0.15, 0.15, 0.2) ## percentage of DE genes, total is 1000 genes
de.prop = c(0, 0.07, 0.15, 0.15, 0.2) ## percentage of DE genes, total is 1000 genes
options(future.globals.maxSize = 15000 * 1024^2)
```
