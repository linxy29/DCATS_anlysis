...
```{r, eval=FALSE}
## Kang's data
exp6_cond1 = read.delim("C:/#Code/R/Ho_DCATS/data/real_word/Exp6_Kang/GSE96583_batch1.total.tsne.df.tsv")
exp6_cond2 = read.delim("C:/#Code/R/Ho_DCATS/data/real_word/Exp6_Kang/GSE96583_batch2.total.tsne.df.tsv")
