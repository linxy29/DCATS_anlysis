...
```{r}
Davie2018 = read.delim(gzfile("/storage/holab/linxy/DCATS/GSE107451_DGRP-551_w1118_WholeBrain_57k_Metadata.tsv.gz")) %>% janitor::clean_names()
summary(Davie2018)
```
...
Davie2018 %>% 
  ...
  group_by(age, genotype, annotation) %>% 
  summarise(n = n())
```
