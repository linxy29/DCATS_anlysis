...
res_all %>% 
  filter(!str_detect(method, "avrgPhi")) %>% 
  filter(!str_detect(method, "adjPhi")) %>% 
...
(pA4+pA2+pA3+pA1)/(pB1 + add_pvalue(stat.testp1, tip.length = 0.015, step.increase = 0.03, colour = "color"))
ggsave("./plot/Fig2.png", width = 10, height = 12)
(pB1 + add_pvalue(stat.testp1, tip.length = 0.015, step.increase = 0.03, colour = "color"))/(pB2)
