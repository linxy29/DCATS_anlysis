...
Set up the group probabilities for Normal and Mutate condtions. Need to change resolution as well.
...
Then, seperate the normal sample and mutate sample by batch and combind them into a list.
