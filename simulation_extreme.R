...
more_negative = ""
countC1 = rep(8, 8)
countC2 = c(12, 12, 12, rep(8,5))
probC1 = countC1/sum(countC1)
probC2 = countC2/sum(countC2)
truthRes = c("P", "P", "P", "N", "N", "N", "N", "N")
...
for (idx in 1:simulation_times) {
  ...
  ## add reference
  ref_order = detect_reference(sim_count, sim_design)
  knnref_order = detect_reference(sim_count, sim_design, simil_matK)
  svmref_order = detect_reference(sim_count, sim_design, simil_matSVM)
