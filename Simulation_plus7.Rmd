...
for (i in 1:simulation_times){
  ...
  ## simulation
  simulation = simulator_fastMNN(totals1 = runif(rep1, 500, 1500), totals2 = runif(rep2, 300, 1500), probC1, probC2, setresolu)
...
save(simulationDF, time, file = "./data/simulationDF/repplicates3&2.RData")
load("./data/simulationDF/repplicates3&2.RData")
head(simulationDF)
```
...
colnames(time) = c("DCATS_wtoM", "DCATS_wM", "fisher", "speckle", "diffcyt", "scDC")
save(simulationDF, time, file = "./data/simulationDF/repplicates6&4.RData")
load("./data/simulationDF/repplicates6&4.RData")
head(simulationDF)
```
...
for (i in 1:simulation_times){
  timeL = rep(NA, 6) # DCATS w/wto simularity matrix, fisher, speckle, diffcyt, scDC
  ## simulation
  simulation = simulator_fastMNN(totals1 = runif(rep1, 500, 1000), totals2 = runif(rep2, 300, 1000), probC1, probC2, setresolu)
  if (is.na(simulation)[1] == FALSE){
    ## data convert
    numb_cond1 = simulation$dfRes %>% 
      filter(condition == "Cond1") %>% 
...
colnames(time) = c("DCATS_wtoM", "DCATS_wM", "fisher", "speckle", "diffcyt", "scDC")
save(simulationDF, time, file = "./data/simulationDF/repplicates10&8.RData")
load("./data/simulationDF/repplicates10&8.RData")
head(simulationDF)
```
...
for (i in 1:simulation_times){
  timeL = rep(NA, 6) # DCATS w/wto simularity matrix, fisher, speckle, diffcyt, scDC
  ## simulation
  simulation = simulator_fastMNN(totals1 = runif(rep1, 1000, 2000), totals2 = runif(rep2, 1000, 2500), probC1, probC2, setresolu)
  if (is.na(simulation)[1] == FALSE){
    ## data convert
    numb_cond1 = simulation$dfRes %>% 
      filter(condition == "Cond1") %>% 
...
colnames(time) = c("DCATS_wtoM", "DCATS_wM", "fisher", "speckle", "diffcyt", "scDC")
save(simulationDF, time, file = "./data/simulationDF/clusters7.RData")
load("./data/simulationDF/clusters7.RData")
head(simulationDF)
```
...
for (i in 1:simulation_times){
  timeL = rep(NA, 6) # DCATS w/wto simularity matrix, fisher, speckle, diffcyt, scDC
  ## simulation
  simulation = simulator_fastMNN(totals1 = runif(rep1, 3000, 4000), totals2 = runif(rep2, 3000, 4000), probC1, probC2, setresolu)
  ## data convert
  numb_cond1 = simulation$dfRes %>% 
    filter(condition == "Cond1") %>% 
    group_by(clusterRes, batch) %>% 
...
```{r}
bin_sum = function(sizeL, prob = 1/2) {
  res = rep(NA, length(sizeL))
  for (i in 1:length(sizeL)){
    res[i] = sum(rbinom(1, sizeL[i], prob))
  }
...
colnames(time) = c("DCATS_wtoM", "DCATS_wM", "fisher", "speckle", "diffcyt", "scDC")
save(simulationDF, time, file = "./data/simulationDF/coverage2.RData")
load("./data/simulationDF/coverage2.RData")
head(simulationDF)
```
