...
```{r}
load("/storage/holab/linxy/DCATS/simulation/replicates/replicates3&3_K8_con100_splatter3000&3000para0210.RData")
```
...
colnames(seurat_count) = c("A", "B", "C", "D", "E", "F", "G", "H", "condition")
colnames(true_count) = c("A", "B", "C", "D", "E", "F", "G", "H", "condition")
```

```{r}
sim2_prop = true_count %>% 
  pivot_longer(A:H, names_to = "cellType", values_to = "count") %>% 
...
sim2_auc = ggroc(list(DCATS=rocobj_dcats, Fisher=rocobj_fisher, diffcyt=rocobj_diffcyt, speckle=rocobj_speckle, scDC=rocobj_scDC, milo=rocobj_milo))+
  geom_point(aes(x=0.958, y=0.725), colour="black", shape = 4) +
  geom_point(aes(x=0.925, y=0.733), colour="black", shape = 4) +
  geom_point(aes(x=0.967, y=0.675), colour="black", shape = 4) +
  geom_point(aes(x=0.742, y=0.642), colour="black", shape = 4) +
  geom_point(aes(x=0.383, y=0.950), colour="black", shape = 4) +
  geom_point(aes(x=0.333, y=0.950), colour="black", shape = 4) +
  labs(color='method')
sim2_auc
```
