...
```{r}
load("/Users/linxy29/Documents/Data/DCATS/simulation/replicates_CI.RData")
replicates_CI %>% knitr::kable()
```
...
```{r}
load("/Users/linxy29/Documents/Data/DCATS/simulation/clusters_CI.RData")
clusters_CI %>% knitr::kable()
```
