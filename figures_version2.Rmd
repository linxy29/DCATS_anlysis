...
replicate2_CI = res_bootstrap %>% 
  ...
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank()) +
  ggtitle("Boxplot of MCC, F1, AUC, PRAUC in simulation with 2 replicates (8 cell types)")
replicate2_CI
```

```{r}
replicate2_CI/replicate3_CI/replicate4_CI
ggsave("./plot/statistics_replicatesCI.png", bg = "transparent", height = 14, width = 10)
```
...
cluster8_CI = res_bootstrap %>% 
  ...
  theme(axis.title.y = element_blank(),
        axis.title.x = element_blank()) +
  ggtitle("Boxplot of MCC, F1, AUC, PRAUC in simulation with 8 cell types (3 replicates)")
cluster8_CI
```

```{r}
cluster8_CI/cluster10_CI/cluster12_CI
ggsave("./plot/statistics_clusterCI.png", bg = "transparent", height = 14, width = 10)
```
...
sim4_mainHM1 = res %>% 
  ...
  mutate(methods = factor(methods, level = c("Fisher", "scDC", "milo", "diffcyt", "speckle",  "DCATS", "dcats_autoRef", "dcats_defRef", "ancombc", "bcancombc"))) %>% 
...
ggsave("./plot/version2/Fig2_2.png", bg = "transparent", height = 14, width = 14)
