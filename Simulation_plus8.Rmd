...
```{r}
cell_pool = "realWorld"  # cell pool used
...
for (i in 1:simulation_times){
  ...
  if (is.na(simulation)[1] == FALSE){
    ...
    if (decider == cluster_num*2) {   # if one cluster has least than 10 cells in one condition, then won't continue
      ...
      ## DCATS---betabin with similarity matrix (backward-forward)
      t2start = Sys.time()
      betabin_wMK = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matK, n_samples = 20, binom_only = FALSE)
      timeL[2] = Sys.time() - t2start
      betabin_wMU = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matU, n_samples = 20, binom_only = FALSE)
      betabin_wMT = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matT, n_samples = 20, binom_only = FALSE)
      betabin_wMT2K = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matT2K, n_samples = 20, binom_only = FALSE)
      timeL[2] = Sys.time() - t2start
      betabin_wMT2T = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matT2T, n_samples = 20, binom_only = FALSE)
      betabin_wMHP1K = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP1K, n_samples = 20, binom_only = FALSE)
      betabin_wMHP2K = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP2K, n_samples = 20, binom_only = FALSE)
      timeL[2] = Sys.time() - t2start
      betabin_wMHP1T = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP1T, n_samples = 20, binom_only = FALSE)
      betabin_wMHP2T = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP2T, n_samples = 20, binom_only = FALSE)
      bin_wMK = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matK, n_samples = 20)
      bin_wMU = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matU, n_samples = 20)
      bin_wMT = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matT, n_samples = 20)
      bin_wMT2K = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matT2K, n_samples = 20)
      bin_wMT2T = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matT2T, n_samples = 20)
      bin_wMHP1K = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP1K, n_samples = 20)
      bin_wMHP2K = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP2K, n_samples = 20)
      bin_wMHP1T = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP1T, n_samples = 20)
      bin_wMHP2T = dcats_betabinRW(as.matrix(numb_cond1), as.matrix(numb_cond2), similarity_mat = simil_matHP2T, n_samples = 20)
      ## Fisher's exact test
      t3start = Sys.time()
...
file_name = str_c("./data/simulationRES/repplicates", as.character(rep1), "&", as.character(rep2), "_K", as.character(cluster_num), "_con", as.character(concentration), "_", cell_pool, ".RData")
