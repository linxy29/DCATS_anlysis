...
```{r}
sim_list_c = vector(mode = "list", length = 9)
integratedSamples_c = vector(mode = "list", length = 9)
```
...
batch_size_list = seq(5000,20000,5000)
setresolu_list = c(0.2, 0.2, 0.14, 0.18)
```
...
```{r}
saveRDS(integratedSamples_c, "./data/integratedSamples_c1.rds")
saveRDS(sim_list_c, "./data/sim_list_c1.rds")
```
