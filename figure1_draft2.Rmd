...
cond1DF = numb_cond1 %>% as.data.frame() %>% 
...
LM_plot1 = condDF %>% 
  ...
  xlab("Replicates") +
  ylab("Proportions")
ggsave("C:/#Code/R/slides/image/RPG_discussion/dcats_background.png", plot = LM_plot1, bg = "transparent", width = 7, height = 3.5)
```
