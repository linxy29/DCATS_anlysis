...
```{r}
sample_dirs = list.dirs(path = "/home/linxy29/R/Ho_DCATS/data/real_world/Exp7_Adam_2017/cellRanger", full.names = TRUE, recursive = FALSE)
...
listSamples = c(control_rawL, day3_rawL)
