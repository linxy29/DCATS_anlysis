...
for (idx in 1:simulation_times) {
  ...
  knnref_order = detect_reference(sim_count, sim_design, simil_matK, phi)$celltype
  svmref_order = detect_reference(sim_count, sim_design, simil_matSVM, phi)$celltype
